...
class GoTermDataset(Dataset):
    ...
    def __init__(self, set_type, task, AF2model=False):
        ...
        self.task = task
        if set_type != 'AF2test':
            prot2annot, goterms, gonames, counts = load_GO_annot("ARF-main/data/nrPDB-GO_2019.06.18_annot.tsv")
        else:
            prot2annot, goterms, gonames, counts = load_GO_annot('ARF-main/data/nrSwiss-Model-GO_annot.tsv')
        ...
        self.processed_dir = 'ARF-main/data/dataset/processed'
